...
Celkově jde o systém nabízející značnou hloubku. Najdeme zde například propracovaný systém komb, velký důraz na správu výdrže a časovací události pro blokování nepřátelských úderů. Hráčské ohlasy dávají za pravdu, že hra nabízí nejrealističtější zážitek boje s chladnou zbraní, jaký najdeme na trhu.

Pokoušet se zde o hloubkový rozbor však nemá valný smysl - byl by to úkol obtížný a jeho splnění by nám nepřineslo mnoho užitku, protože implementace jakéhokoliv jednoho dílčího aspektu takového bojového systému se naprosto vymyká finančním i časovým možnostem autora této práce.
