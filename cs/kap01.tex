...
Očividnou oblastí, kde můžeme najít ovladač poskytující 3D vstup, je virtuální realita (dále jen \acs{VR}). Tento fenomén v posledním desetiletí zažívá rozkvět. Bylo vydáno mnoho headsetů a na dalších probíhá práce. Konkurenční boj pohání inovaci a ceny vybavení tlačí dolů 
