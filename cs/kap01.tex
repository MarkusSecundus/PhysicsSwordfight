...
Pro dosažení koordinace je však nutná \textbf{komunikace}. Při šarvátce, rozplánovat si postup v omezeném čase a aniž by plán byl zachycen protivníkem vskutku není triviální problém. V kontextu větší bitvy pak důležitost i obtížnost komunikace nabývá zcela nového rozměru a jde o těžký problém, který až do vynálezu moderní vysílačky nebyl uspokojivě vyřešen. Vojenská taktika si vyžaduje flexibilní reakce na změny situace na bojišti, informace musí proudit mezi vojenskými jednotkami a velitelstvím, které jsou často fyzicky netriviálně vzdálené. Jednou možností, jak informaci předat, je vyslání posla - ten je schopen nést detailní informaci, je však zranitelný a pomalý - než dorazí, může již jeho informace být neaktuální. Druhou možností je broadcast předem dohodnutých signálů, napříkald prostřednictvím trubače - tato cesta je rychlá a do určité vzdálenosti vcelku spolehlivá, avšak signály musí být předem dohodnuté a nemůže jich být mnoho, postrádá tedy flexibilitu a detailnost informace. Jak vidno, jde o velmi důležitou součást vedení bitvy, přesto však vidíme mnoho videoher ji zcela zanedbat.
\bigbreak
Dojde-li k boji \textbf{jediného bojovníka proti přesile}, vše výše uvedené stále platí, akorát očividně ony obrovské výhody plynoucí z koordinovaného postupu jsou dopřány pouze jedné ze stran. I pro velmi zkušeného šermíře bojujícího proti několika nezkušeným, často jediná šance, jak z takové situace vyváznout, je protivníky rozdělit (kreativním použitím pohybu a znalosti terénu) a zdolat je jednoho po druhém rychle aby ostatní nepřišli na pomoc.
