...
Nyní, když máme rámcovou představu, jak boj s chladnou zbraní vypadá v reálném světě, nastíníme si, jakým způsobem bývá typicky adaptován ve videohrách - jaké jeho aspekty byly tímto universem věrně přejaty, jaké ignorovány, a jaké interpretovány s řádnou dávkou umělecké kreativity.

\subsection{Obecný přehled}

Jako většinu fenomenů majících svůj předobraz v reálném světě, i boj s chladnou zbraní svět videoher pojal způsobem silně zjednodušeným a stylizovaným.
