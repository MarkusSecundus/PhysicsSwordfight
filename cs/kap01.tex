...
Neprve se zamysleme, proč by hráč o větší kontrolu mohl mít zájem:
\begin{itemize}
    ...
    \item \textbf{Chce zkusit něco nového} - Mnoho hráčů se již zkrátka nudí z donekonečna omýlaného klišé, jakým se boj s chladnou zbraní stal - líbí se jim téma, ale zároveň ho chtějí zkusit pojaté neotřelým způsobem.
\end{itemize}

Dále, jaké benefity by takový přístup mohl přinést tvůrci hry:
\begin{itemize}
    \item \textbf{Emergentní gameplay} - 
    \item \textbf{Nástroj interakce s okolním prostředím} - 
\end{itemize}

Vidíme, že motivace k umožnění větší kontroly je silně nezanedbatelná. Očividně tedy takovým tendencím musí stát v cestě výrazné překážky vzhledem k tomu, že víme, že se jim dosud nepodařilo ovládnout herní mainstream.
