...
\begin{itemize}
  \item \textbf{Šermíř}
    \begin{itemize}
      ...
      \item z parenta si natáhne instanci ISwordInput - na něm se ptá na hodnoty vstupních Axis a podle nich působí silama aby vyvolával pohyb hráče
      ...
      \item jak probíhá pohyb a rotace hráče
       ...
       \item podrobné animované tělo pro kolize s mečem - viz \ref{swordsmanAnimationSubsection}
    \end{itemize}
  \item \textbf{Meč}
    \begin{itemize}
