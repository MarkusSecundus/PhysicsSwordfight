...
Algoritmus umělé inteligence implementuje komponenta \textit{SwordsmanAI} - tu jsme přidali do kořenového objektu spolu s komponentou \textit{InputSimulator}, kterou jsme nahradili za původní \textit{BasicSwordInput}.
...
\subsubsection*{Ovládání meče - zamyšlení}
\begin{itemize}
  \item Mohli bychom pořizovat nahrávky paprsků z uživatelského vstupu - pak by s pohybem i s mečem komunikovalo AI dohromady stejnou cestou
  \item Když však budeme nahrávat přímo SwordMovement.MoveSword() instrukce a necháme aby je přehrával specielní SwordMovement.Module...
    \begin{itemize}
      \item takový záznam je pro nás transparentnější, můžeme nad instrukcemi např. provádět maticové transformace apod. a libovolně pohyb meče měnit
      \item takovej mechanismus pro přehrávání nahrávek bychom pak mohli zadarmo použít i jako dodatečnej mod pro hráčského šermíře - jako to dělá DbtS 
    \end{itemize}
\end{itemize}

\subsubsection*{Ovládání meče - pořízení nahrávek}
\begin{itemize}
...
\subsubsection*{Ovládání meče - přehrávání nahrávek}
\begin{itemize}
...
-máme tedy \acs{NPC} rytíře, co je schopný samostatně chodit po terénu a nebezpečně mávat mečem, drtivou většinu vnitřní logiky sdílí s \acs{PC}
