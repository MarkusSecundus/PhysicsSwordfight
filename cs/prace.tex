...
\usepackage{csquotes} % bez tohoto package crashuje build 
...
\def\Podekovani{%
Rad bych poděkoval svému vedoucímu Mgr. Vojtěchu Černému za jeho trpělivost, mnoho cenných rad a podnětů, bez kterých by práce nemohla vzniknout.
Dále rodině a přátelům, kteří mi po celou dobu poskytovali duševní podporu.

Specificky rovněž kamarádům, kteří mě kdysi přivedli k LARPu, z čehož vzešla inspirace pro téma této práce.
}
